...
class Gallery extends Component {
  state = {initialImageList: imagesList[0].id}

  setActiveThumbnailId = id => {
    this.setState({initialImageList: id})
  }
    ...
    return (
      <div className="app-container">
        <div className="gallery-container">
          <img
            src={imagesList[initialImageList].imageUrl}
            alt={imagesList[initialImageList].imageAltText}
          ...
          <ul className="thumbnails-list">
            {imagesList.map(eachImage => (
              <ThumbnailItem
                ...
                isActive={initialImageList === eachImage.id}
